function [uElements, uCounts, uElements2v, v2uElements] = countUniqueRows(v)
% [uCounts, uElements] = countUnique(items) count the number of times each
% unique item appears in a vector
...
[uElements, uElements2v, v2uElements] = unique(v, 'rows');
